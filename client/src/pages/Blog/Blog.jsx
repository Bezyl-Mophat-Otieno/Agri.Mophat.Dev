...
import "./Blog.css";
import img from "../../assets/images/blog/10.jpg";
import img1 from "../../assets/images/blog/05.jpg";
import img3 from "../../assets/images/blog/06.jpg";
import img2 from "../../assets/images/blog/08.jpg";
import img4 from "../../assets/images/blog/07.jpg";
import img5 from "../../assets/images/blog/09.jpg";
import img6 from "../../assets/images/blog/12.jpg";
              ...
              <div class="col-lg-6">
                <div class="card bg-transparent mb-4 mb-sm-0">
                  ...
                  <div class="card-body px-3 pb-0">
                    <span>
                      <i class="bi bi-calendar2-plus me-2"></i>April 28, 2022
                    </span>
                    ...
                    <p class="mb-0">
                      Prospective agents should start broadly and then narrow
                      their list down to.
                    </p>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-2">
                      <h6 class="mb-0">
                        By <a href="#">Joan Wallace</a>
                      </h6>
                      <Link to="/blog-detail" class="btn btn-link p-0 mb-0">
                      ...
                      <div class="col-8">
                        ...
                        <div class="card-body p-0">
                          <h5 class="card-title mb-sm-3">
                            <Link to="/blog-detail" class="stretched-link">
                              Bad habits that people in the business industry
                              need to quit
                            </Link>
                          </h5>
                          {/* <!-- Author name and button --> */}
                          <div class="d-flex justify-content-between align-items-center">
                            <span class="small">
                              <i class="bi bi-calendar2-plus me-2"></i>Sep 01,
                              2022
                            </span>
                            <a
                  ...
                  <div class="card bg-transparent">
                    <div class="row g-3 g-sm-4 align-items-sm-center">
                      ...
                      <div class="col-8">
                        ...
                        <div class="card-body p-0">
                          <h5 class="card-title mb-sm-3">
                            <a href="blog-detail.html" class="stretched-link">
                          ...
                          <div class="d-flex justify-content-between align-items-center">
                            <span class="small">
                              <i class="bi bi-calendar2-plus me-2"></i>Sep 15,
                              2022
                            </span>
                            <a
                              href="blog-detail.html"
                    ...
                    <div class="row g-3 g-sm-4 align-items-sm-center">
                      ...
                      <div class="col-8">
                        ...
                        <div class="card-body p-0">
                          <h5 class="card-title mb-sm-3">
                            <a href="blog-detail.html" class="stretched-link">
                              Ten unconventional tips about startups that you
                          ...
                          <div class="d-flex justify-content-between align-items-center">
                            <span class="small">
                              <i class="bi bi-calendar2-plus me-2"></i>Sep 28,
                              2022
                            </span>
                            <a
                              href="blog-detail.html"
          ...
          <div class="container">
            ...
            <div class="row g-4">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card bg-light p-3">
                  <div class="card-body">
                    {/* <!-- Badge --> */}
                    <a href="#" class="badge text-white bg-primary mb-2">
                      Research
                    </a>
                    {/* <!-- Title --> */}
                    <h5 class="card-title">
                    ...
                    <p>
                      Prospective should start broadly and then narrow their
                      list down to colleges that best fit their needs, experts
                      say. Yet remarkably appearance gets him his projection.{" "}
                    </p>
                    <h6 class="fw-light mb-0">
                      By <a href="#">Louis Crawford</a>
                    </h6>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card h-100 bg-transparent">
                  ...
                  <div class="card-body p-3 pb-0">
                    ...
                    <h5 class="card-title">
                      <a href="blog-detail.html">
                        10 things you need to know about Booking
                      </a>
                    </h5>
                    <h6 class="fw-light mb-0">
                      By <a href="#">Amanda Reed</a>
                    </h6>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card bg-transparent">
                  ...
                  <div class="position-relative">
                    ...
                    {/* <!-- Badge --> */}
                    <div class="card-img-overlay p-3">
                      <a href="#" class="badge text-bg-dark mb-2">
                        Adventure
                      </a>
                    </div>
                  </div>
            ...
            <div class="text-center mt-4">
              <a href="#" class="btn btn-primary-soft mb-0">
                Load more<i class="fas fa-sync ms-2"></i>
              </a>
            </div>
          </div>
        </section>
                    ...
                    <div class="col-md-7 text-center mx-auto py-md-5">
                      ...
                      <form class="bg-body rounded-2 p-2">
                        <div class="input-group">
                          ...
                          <button
                            type="button"
                            class="btn btn-primary rounded-2 mb-0"
                          >
                            Subscribe!
                          </button>
                        </div>
