...
import img1 from "../../assets/images/avatar/02.jpg";
import img2 from "../../assets/images/avatar/03.jpg";
import img3 from "../../assets/images/avatar/04.jpg";
import img4 from "../../assets/images/avatar/05.jpg";
import img5 from "../../assets/images/team/01.jpg";
import img6 from "../../assets/images/team/02.jpg";
import img7 from "../../assets/images/team/03.jpg";
import img8 from "../../assets/images/team/04.jpg";
import img9 from "../../assets/images/team/05.jpg";
import img10 from "../../assets/images/team/06.jpg";
import img11 from "../../assets/images/team/07.jpg";
import img12 from "../../assets/images/team/08.jpg";
import img13 from "../../assets/images/team/09.jpg";
import img15 from "../../assets/images/team/10.jpg";
  ...
  return (
    <>
      ...
      <main>
            ...
            <div class="row g-4 justify-content-between">
              ...
              <div class="col-lg-4 col-xl-3">
                <div class="card card-body shadow p-4">
                  <h6 class="text-primary fw-normal mb-3">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    {/* <!-- Rating --> */}
                    <span class="h6 mb-0">
                      <i class="fa-solid fa-star text-warning me-1"></i>4.9
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div class="row g-4">
                  ...
                  <div class="card-img-scale-wrapper rounded-3">
                    ...
                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                      ...
                      <span class="badge text-bg-white">
                        <i class="fa-solid fa-star text-warning me-2"></i>4.3
                      </span>
                      {/* <!-- Social button --> */}
              ...
              <div class="col-sm-6 col-md-4 col-xl-3">
                <div class="card card-img-scale card-element-hover overflow-hidden bg-transparent">
                  <div class="card-img-scale-wrapper rounded-3">
                    {/* <!-- Image --> */}
                    <img src={img10} class="card-img" alt="" />
                    {/* <!-- Card overlay --> */}
                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                      {/* <!-- Badge --> */}
                      <span class="badge text-bg-white">
              ...
              <div class="col-sm-6 col-md-4 col-xl-3">
                <div class="card card-img-scale card-element-hover overflow-hidden bg-transparent">
                  <div class="card-img-scale-wrapper rounded-3">
                    {/* <!-- Image --> */}
                    <img src={img13} class="card-img" alt="" />
                    {/* <!-- Card overlay --> */}
                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                      {/* <!-- Badge --> */}
                      <span class="badge text-bg-white">
              ...
              <div class="col-sm-6 col-md-4 col-xl-3">
                <div class="card card-img-scale card-element-hover overflow-hidden bg-transparent">
                  <div class="card-img-scale-wrapper rounded-3">
                    {/* <!-- Image --> */}
                    <img src={img15} class="card-img" alt="" />
                    {/* <!-- Card overlay --> */}
                    <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                      {/* <!-- Badge --> */}
                      <span class="badge text-bg-white">
        ...
        <section>
          <div class="container">
            <div class="bg-warning bg-opacity-50 rounded-3 p-4 p-sm-5">
              <div class="row align-items-center position-relative">
                ...
                <div class="col-lg-4 text-lg-end">
                  <a href="flight-list.html" class="btn btn-lg btn-dark mb-0">
