...
import img from "../../assets/images/element/17.svg";
import img1 from "../../assets/images/category/hotel/4by3/02.jpg";
import img2 from "../../assets/images/element/16.svg";
...
import img6 from "../../assets/images/element/12.svg";
import img7 from "../../assets/images/element/14.svg";
import img8 from "../../assets/images/element/paypal.svg";
                        ...
                        <div class="row align-items-center">
                          ...
                          <div class="col-sm-6 col-md-9">
                            <div class="card-body pt-3 pt-sm-0 p-0">
                              {/* <!-- Title --> */}
                              <h5 class="card-title">
                                <a href="#">Pride moon Village Resort & Spa</a>
                              </h5>
                              <p class="small mb-2">
                                <i class="bi bi-geo-alt me-2"></i>5855 W Century
                      ...
                      <div class="row g-4">
                        ...
                        <div class="col-lg-4">
                          <div class="bg-light py-3 px-4 rounded-3">
                            ...
                            <small>
                              <i class="bi bi-alarm me-1"></i>12:30 pm
                            </small>
                          </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                          <div class="bg-light py-3 px-4 rounded-3">
                            ...
                            <small>
                              <i class="bi bi-alarm me-1"></i>4:30 pm
                            </small>
                          </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                          <div class="bg-light py-3 px-4 rounded-3">
                            ...
                            <small>
                              <i class="bi bi-brightness-high me-1"></i>3 Nights
                              - 4 Days
                            </small>
                          </div>
                        </div>
                  ...
                  <div class="card shadow">
                    ...
                    <div class="card-body p-4">
                      ...
                      <div class="alert alert-info my-4" role="alert">
                        <a href="sign-up.html" class="alert-heading h6">
                          Login
                        </a>{" "}
                          ...
                          <form class="hstack flex-wrap gap-3">
                            ...
                            <div class="form-check">
                              <input
                                ...
                                id="hotelType4"
                              />
                              <label class="form-check-label" for="hotelType4">
                            ...
                            <div class="form-check">
                              <input
                                ...
                                id="hotelType5"
                              />
                              <label class="form-check-label" for="hotelType5">
                                Large bed
                              </label>
                            </div>
                            {/* <!-- Checkbox --> */}
                            <div class="form-check">
                              <input
                                ...
                                id="hotelType6"
                              />
                              <label class="form-check-label" for="hotelType6">
                                Airport transfer
                              </label>
                            </div>
                            {/* <!-- Checkbox --> */}
                    ...
                    <div class="card-body p-4 pb-0">
                      ...
                      <div class="bg-primary bg-opacity-10 rounded-3 mb-4 p-3">
                        <div class="d-md-flex justify-content-md-between align-items-center">
                          ...
                          {/* <!-- Button --> */}
                          <a href="sign-in.html" class="btn btn-primary mb-0">
                            Login now
                          </a>
                        </div>
                      </div>
                              ...
                              <div class="d-sm-flex justify-content-sm-between my-3">
                                ...
                                <ul class="list-inline my-0">
                                  <li class="list-inline-item">
                                    {" "}
                                    <a href="#">
                                      <img src={img3} class="h-30px" alt="" />
                                    </a>
                                  </li>
                                  <li class="list-inline-item">
                                    {" "}
                                    <a href="#">
                                      <img src={img4} class="h-30px" alt="" />
                                    </a>
                                  </li>
                                  <li class="list-inline-item">
                                    {" "}
                                    <a href="#">
                                      <img src={img5} class="h-30px" alt="" />
                                    </a>
                                  </li>
                                </ul>
                              </div>
                              ...
                              <form class="row g-3">
                                ...
                                <div class="col-12">
                                  ...
                                  >
                                    ...
                                    <div class="d-sm-flex align-items-center mb-3">
                                      <img
                                        src={img6}
                                        class="w-40px me-3 mb-2 mb-sm-0"
                                        alt=""
                                      />
                                    ...
                                    <p class="mb-2">
                                      ...
                                      is going to run a bit longer so that you
                                    ...
                                    <div class="d-sm-flex align-items-center">
                                      <a
                                        href="#"
                                        class="btn btn-sm btn-success mb-2 mb-sm-0 me-3"
                                      >
                                ...
                                <div class="col-12">
                                  <div class="d-sm-flex justify-content-sm-between align-items-center">
                                    <h4>
                                      $1800{" "}
                                      <span class="small fs-6">Due now</span>
                                    </h4>
                          ...
                          >
                            ...
                            <div class="accordion-body">
                              <div class="card card-body border align-items-center text-center mt-4">
                                {/* <!-- Image --> */}
                                <img src={img8} class="h-70px mb-3" alt="" />
                                <p class="mb-3">
