          ...
          <div class="container">
            <div class="card rounded-3 border p-3 pb-2">
              ...
              <div class="d-sm-flex align-items-center">
                ...
                >
                  <i class="bi bi-plus-lg fa-fw me-2"></i>Add New Product
                </Link>
              </div>
              {/* <!-- Avatar and info START --> */}
                ...
                <div class="offcanvas-body p-3 p-xl-0">
                  ...
                  <div class="navbar navbar-expand-xl">
                    <ul class="navbar-nav navbar-offcanvas-menu">
                      <li class="nav-item">
                        {" "}
                        <a class="nav-link active" href="agent-dashboard.html">
                      ...
                      <li class="nav-item">
                        {" "}
                        <a class="nav-link" href="agent-listings.html">
                      ...
                      <li class="nav-item">
                        ...
                        <a class="nav-link" href="agent-activities.html">
                          <i class="bi bi-bell fa-fw me-1"></i>Activities
                        </a>{" "}
                      </li>
                      ...
                      <li class="nav-item">
                        ...
                        <a class="nav-link" href="agent-earnings.html">
                          <i class="bi bi-graph-up-arrow fa-fw me-1"></i>
                          Earnings
                        </a>{" "}
                      </li>
                      ...
                      <li class="nav-item">
                        ...
                        <a class="nav-link" href="agent-reviews.html">
                          <i class="bi bi-star fa-fw me-1"></i>Reviews
                        </a>
                      </li>
          ...
          <div class="container vstack gap-4">
            ...
            {/* <ul class="list-group list-group-borderless align-items-center mt-3">
                      <li class="list-group-item">
                        <i class="text-primary fas fa-circle me-2"></i>Organic
                      </li>
                      <li class="list-group-item">
                        <i class="text-success fas fa-circle me-2"></i>Google
                      </li>
                      <li class="list-group-item">
                        <i class="text-warning fas fa-circle me-2"></i>Social
                        media
                      </li>
                      <li class="list-group-item">
                        <i class="text-danger fas fa-circle me-2"></i>Referral
                        program
                      </li>
                    </ul>
                  </div>
                      ...
                      <table class="table align-middle p-4 mb-0 table-hover table-shrink">
                        ...
                        <tbody class="border-top-0">
                          ...
                          <tr>
                            ...
                            <td>
                              {" "}
                              Free Cancellation | Breakfast + Lunch/Dinner{" "}
                            </td>
                            <td> Nov 24 - 28 </td>
                            <td>
                              {" "}
