    ...
    <div>
      ...
      <main>
        ...
        <section class="pt-0">
          <div class="container">
            {/* <!-- Background image --> */}
            <div class="rounded-3 p-3 p-sm-5 custom">
              {/* <!-- Banner title --> */}
              <div class="row my-2 my-xl-5">
                <div class="col-md-8 mx-auto">
                  <h1 class="text-center text-black custom-font">
                    Where Every Seed Holds a Story, and Every Harvest Sows a
                    Promise.
                  </h1>
                </div>
              </div>
                ...
                <form class="row g-4">
                    ...
                    <div class="form-control-borderless">
                      ...
                      <div class="position-relative">
                        <div class="noui-wrapper">
                          ...
                          <div
                            class="noui-slider-range mt-2"
                            data-range-min="500"
                            data-range-max="2000"
                            data-range-selected-min="700"
                            data-range-selected-max="1500"
                          ></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-control-borderless">
                      ...
                      <ul class="list-inline mb-0 g-3">
                        ...
                        <li class="list-inline-item">
                          ...
                          />
                          <label
                            class="btn btn-white btn-primary-soft-check"
                            for="btn-check-1"
                          >
                            3+
                          </label>
                  ...
                  <div class="col-12">
                    ...
                    <div class="text-end align-items-center">
                      ...
                      <button class="btn btn-dark mb-0 ms-3">
                        Apply filter
                      </button>
                    </div>
                  </div>
            ...
            <div class="row g-4">
              ...
              <div class="col-md-6 col-xl-4">
                <div class="card shadow p-2 pb-0 h-100">
                  {/* <!-- Image --> */}
                  <img src={img1} class="rounded-2" alt="Card image" />
                  ...
                  <div class="card-body px-3 pb-0">
                    ...
                    {/* <!-- Title --> */}
                    <h5 class="card-title">
                      <Link to="/product">African Cabbage</Link>
                    </h5>
                  </div>
                  {/* <!-- Card body END --> */}
                  ...
                  <div class="card-footer pt-0">
                    ...
                    <div class="d-sm-flex justify-content-sm-between align-items-center">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <span class="mb-0 me-2">/50kg</span>
                      </div>
                      {/* <!-- Button --> */}
              ...
              <div class="col-md-6 col-xl-4">
                <div class="card shadow p-2 pb-0 h-100">
                  {/* <!-- Image --> */}
                  <img src={img2} class="rounded-2" alt="Card image" />
                  ...
                  <div class="card-body px-3 pb-0">
                    ...
                    {/* <!-- Title --> */}
                    <h5 class="card-title">
                      <Link to="/product">Green Pepper</Link>
                    </h5>
                  </div>
                  {/* <!-- Card body END --> */}
                  ...
                  <div class="card-footer pt-0">
                    ...
                    <div class="d-sm-flex justify-content-sm-between align-items-center">
                      {/* <!-- Price --> */}
                      <div class="d-flex align-items-center">
                        <h5 class="fw-normal text-success mb-0 me-1">Ksh500</h5>
                        <span class="mb-0 me-2">/20kg</span>
                      </div>
                      {/* <!-- Button --> */}
                      <div class="mt-2 mt-sm-0 z-index-2">
                        <a
